...
namespace AvaloniaPluginApp.Services;
...
public class PluginService : ObservableBackgroundService
{
    ...
    {
        Plugins.Add(new PluginInfo("Test", @"../../../../AvaloniaPluginSample/bin/Debug/net7.0/AvaloniaPluginSample.dll"));
        Plugins.Add(new PluginInfo("Test2", @"../../../../AvaloniaPluginSample/bin/Debug/net7.0/AvaloniaPluginSample.dll"));
    }
